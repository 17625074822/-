<template>
  <div id="paymentin">
    <van-row class="head">
      ...
      <van-col span="8">
        <van-button to="/nocashin"
                    class="init-month"
                    @click="monthActive"
                    :style="month">当月待收</van-button>
      </van-col>
      <van-col span="8">
        <van-button to="/nocashin/2"
                    @click="quarterActive"
                    :style="quarter">季度待收</van-button>
      </van-col>
      <van-col span="8">
        <van-button to="/nocashin/3"
                    @click="yearActive"
                    :style="year">年度待收</van-button>
      </van-col>
    </van-row>
    <!-- 账面收支信息 -->
    ...
    <ul class="payment-wrap">
      <li v-for="(item,index) in paymentList"
          :key="index"
          v-show="item.total_money != item.paid_money && item.type=='1'">
